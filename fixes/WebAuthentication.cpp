...
static bool getMD5(uint8_t * data, uint16_t len, char * output) { // 33 bytes or more
    ...
    mbedtls_md5_starts(&_ctx);  // Updated from mbedtls_md5_starts_ret
    mbedtls_md5_update(&_ctx, data, len);  // Updated from mbedtls_md5_update_ret
    mbedtls_md5_finish(&_ctx, _buf);  // Updated from mbedtls_md5_finish_ret
#else
    MD5Init(&_ctx);
